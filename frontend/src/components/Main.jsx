...
const Main = () => {
  return (
    <div className="flex items-center justify-center mb-8 md:mb-12">
      <div className="w-full md:w-5/6 lg:w-[90%] max-w-screen-lg p-4 md:p-10 h-auto rounded-xl bg-slate-400 flex flex-col md:flex-row items-center justify-around gap-4 md:gap-8">
